  ...
  <div class="wojo form">
    <form method="post" id="modal_form" name="modal_form">
      <div class="wojo block fields">
        <div class="field">
          <textarea name="short_CV" id="freelancer-note" class="height-130" cols="30" rows="10" placeholder="Enter short CV to freelancer that you have chosen"><?php if (isset($this->row->short_CV)) echo$this->row->short_CV; ?></textarea>
        </div>
      </div>
    </form>
  </div>
