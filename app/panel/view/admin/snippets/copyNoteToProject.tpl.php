<?php
   ...
   * @copyright 2019
   * @version $Id: copyNoteToProject.tpl.php,, v1.00 2019-03-02 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
?>
<div class="header">
  <h5><?php echo str_replace("[NAME]", '<span class="wojo secondary text">' . $this->row->name  . '</span>', Lang::$word->NOT_TITLE);?></h5>
</div>
<div class="body">
  <div class="wojo form">
