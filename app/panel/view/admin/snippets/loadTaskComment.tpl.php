    ...
    <div class="row align middle">
      ...
      <div class="columns auto">
        ...
        <div class="wojo dropdown small pointing top-right" id="discDrop_<?php echo $data['row']->id;?>">
          ...
          <a data-set='{"option":[{"trash": "trashTaskMessage","title": "<?php echo Validator::sanitize(Lang::$word->TSK_SUB15 . ' #' . $i, "chars");?>","id":<?php echo $data['row']->id;?>,"task_id":<?php echo $data['items']['id'];?>, "pid":<?php echo $data['items']['pid'];?>,"taskname": "<?php echo $data['items']['taskname'];?>"}],"action":"trash","subtext":"<?php echo Lang::$word->DELCONFIRM3;?>", "parent":"#item_<?php echo $data['row']->id;?>"}' class="item wojo demi text data">
