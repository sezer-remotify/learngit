<?php
   ...
   * @copyright 2019
   * @version $Id: _reports_time.tpl.php, v1.00 2019-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="wojo card">
  <div class="wojo small text secondary header">
    <div class="items">
      <h4><?php echo Lang::$word->REP_SUB7;?></h4>
    </div>
    <div class="items"><?php echo Lang::$word->TOTAL . ': ' . Utility::decimalToHumanHour(Stats::doArraySum($this->result, "hours"));?></div>
  </div>
  <div class="content">
    <div class="row">
      <div class="columns">
        <div class="wojo small light rounded buttons" id="dSort">
          ...
          <a data-type="job" class="wojo button"><?php echo Lang::$word->CMP_JOBT;?></a>
        </div>
      </div>
      <div class="columns auto"><a href="<?php echo ADMINVIEW;?>/helper.php?action=getTimeRecordsCvs" class="wojo small icon button"><i class="icon wysiwyg table"></i></a>
      </div>
    </div>
  </div>
</div>
<div class="wojo segment" id="results">
  ...
  <div id="dWrap">
    <table class="wojo small basic table">
      ...
      <?php $i++;?>
      <?php $hours = Utility::decimalToHumanHour(Stats::doArraySum($this->data[$name], "hours"));?>
...
<script src="<?php echo ADMINVIEW;?>/js/reportsTime.js"></script>
