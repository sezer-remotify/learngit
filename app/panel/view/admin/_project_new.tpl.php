<?php
   ...
   * @copyright 2019
   * @version $Id: _project_new.tpl.php, v1.00 2019-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="wojo heading message">
  <div class="content">
    <h3><?php echo Lang::$word->PRJ_TITLE1;?></h3>
  </div>
</div>
  ...
  <div class="wojo form gutters segment">
    <div class="wojo fields">
      <div class="field">
        ...
        <input placeholder="<?php echo Lang::$word->PRJ_PRJNAME;?>" type="text" name="name">
      </div>
    </div>
    <div class="wojo fields">
      <div class="field">
  ...
  <div class="wojo form segment">
    <div class="wojo fields">
      ...
      <div class="field">
        ...
        <p class="wojo small grey text"><?php echo Lang::$word->PRJ_LABEL_T;?></p>
      </div>
    </div>
    <div class="wojo fields">
      <div class="field four wide labeled">
