<?php
   ...
   * @copyright 2019
   * @version $Id: _invoice_new.tpl.php, v1.00 2019-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
      die('Direct access to this location is not allowed.');
?>
<h3><?php echo ($this->segments[2] == "newr") ? Lang::$word->INV_NEWINVR : Lang::$word->INV_TITLE1;?></h3>
<div class="wojo small white stacked buttons">
  <a href="<?php echo Url::url("/admin/invoices", "recurring");?>" class="wojo button"><?php echo Lang::$word->INV_TITLE7;?></a>
...
<form method="post" id="invoiceForm" name="wojo_form">
  <div class="wojo spaced segment form">
    ...
    <?php if($this->segments[2] == "newr"):?>
    <div class="wojo fields align middle">
      <div class="field four wide labeled">
        <label><?php echo Lang::$word->INV_REC_NAME;?>
          <i class="icon asterisk"></i>
        </label>
      </div>
      <div class="field">
        <input placeholder="<?php echo Lang::$word->INV_REC_NAME;?>" type="text" name="title">
      </div>
    </div>
    <?php endif;?>
    <div class="wojo fields align middle">
    ...
    <div class="wojo fields align middle">
      ...
      <div class="field">
        <input name="created" type="text" value="<?php echo Date::doDate("dd/MM/yyyy", date('Y-m-d'));?>" readonly class="datepick">
      </div>
    </div>
    <?php if($this->segments[2] == "new"):?>
    <div class="wojo fields align middle">
      <div class="field four wide labeled">
    ...
    <div class="wojo fields align middle">
      <div class="field four wide labeled">
        <label><?php echo Lang::$word->INV_FREQ;?><i class="icon asterisk"></i></label>
      </div>
      <div class="field">
        <div class="wojo fluid input">
          <input name="recurring_t" value="30" type="text">
        </div>
      </div>
      <div class="field">
        <select name="recurring_p">
          <?php echo Utility::loopOptionsSimpleAlt(Date::getMembershipPeriod());?>
        </select>
      </div>
    </div>
    <input type="hidden" name="due_date" value="<?php echo Date::today();?>">
  ...
  <div class="wojo fitted segment form">
    ...
    <div class="content">
      ...
      <div class="wojo small toggle checkbox">
        <input name="freeform" type="radio" value="1" onchange="$('#tep').slideToggle()" id="freeform_2">
        <label for="freeform_2"><?php echo Lang::$word->INV_SUB4_2;?></label>
      </div>
      <div class="hide-all" id="tep">
            ...
            <div class="row grid phone-1 mobile-1 tablet-2 screen-2 small gutters">
              ...
              <div class="columns">
                <div class="wojo radio fitted checkbox">
                  <input type="radio" name="project" value="<?php echo $prow->id;?>" id="projectLabel_<?php echo $prow->id;?>">
        ...
        <div class="wojo fields">
          ...
          <div class="basic field">
            <div class="wojo fitted checkbox">
              <input name="timerecord" type="checkbox" value="1" id="timeRecord">
              <label for="timeRecord"><?php echo Lang::$word->INV_SUB5_1;?></label>
            </div>
            <div class="top margin">
              <div class="wojo fitted checkbox">
                <input name="expense" type="checkbox" value="1" id="timeExpense">
