  ...
  <li>
    ...
    <div class="content">
      ...
      <div class="item wojo small text">
        ...
        <a href="<?php echo Url::url("/admin/members/details", $arow->uid);?>" class="inverted"><?php echo $arow->fullname;?></a>
        <span class="wojo separator"></span>
        <?php if($arow->groups == "history"):?>
        <?php echo Users::activityHistoryStatus($arow);?>
        <?php else:?>
        <?php echo Users::activityStatus($arow);?>
        <?php endif;?>
      </div>
      <?php endforeach;?>
    </div>
