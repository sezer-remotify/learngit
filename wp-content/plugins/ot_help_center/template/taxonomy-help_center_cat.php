...
get_header();?>
<!--Help Center section-->
<section id="help-center" class="tCenter ofsTop ofsBottom">
	<!--Container-->
	<div class="container clearfix">
		<h1 class="title tCenter"><?php printf( __( 'Category Archives Help Center: %s', '$textdoimain' ), single_cat_title( '', false ) ); ?></h1>
	</div>
	<!--End container-->
			...
			<li class="item">
				<div class="itemDesc">
					...
					<div class="doubleBtn itemBtn ">
						<a href="<?php echo esc_url(wp_get_attachment_url( get_post_thumbnail_id()));?>" class="doubleLeft help-center"><i class="icon-eye"></i></a>
